...
const Affiliate = () => {
  return (
    <div className="flex flex-nowrap items-center justify-center md:flex-wrap md:justify-start ">
      <div>
      <h4 className="text-lg mx-20">An affiliate tracking platform made for affiliates <span className="text-orange-500">by affiliates</span></h4>
